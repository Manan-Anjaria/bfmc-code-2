...
if config["speed"]:
    activity_config = {
        # "nodes": [[86, 78], [87, 49], [308, 426], [427, 467], [468, 229], [230, 232], [233, 183], [186, 197], [63, 146], [25, 121]], 
        "nodes": [[86, 308], [309, 467]],
        "activity": ["navigation", "finish", "temp", "temp", "temp", "temp", "temp", "temp", "temp", "temp"]
    }
else:
    activity_config = {
